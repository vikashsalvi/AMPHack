package com.AmpHack.book_transit.Chat;
...
import com.AmpHack.book_transit.SoundClient.Sender.BufferSoundTask;
...
import com.AmpHack.book_transit.SoundClient.Receiver.RecordTask;
        ...
        if(CallbackSendRec.SEND_ACTION==srFlag && isSending){
            ...
            if(CallbackSendRec.RECEIVE_ACTION==srFlag && isListening){
                ...
                if(!message.equals("")){
                    ...
                    System.out.println("ypppp   " + message);

                    //((TextView) findViewById(R.id.edittext_chatbox)).setText(message);
                    ...
                    final View view = factory.inflate(R.layout.tick, null);
                    alertDialog.setView(view);
                    alertDialog.setTitle("Alert");
                    alertDialog.setMessage("Ticket Booked");
