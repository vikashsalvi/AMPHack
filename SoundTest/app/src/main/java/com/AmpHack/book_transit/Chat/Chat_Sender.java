...
public class Chat_Sender extends AppCompatActivity implements CallbackSendRec{
    ...
    private void stopSending(){
        ((Button) findViewById(R.id.button_chatbox_send)).setText("Book ticket");
