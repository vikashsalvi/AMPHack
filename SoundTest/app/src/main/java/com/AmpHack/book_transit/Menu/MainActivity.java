...
import com.AmpHack.book_transit.Chat.ChatActivity;
import com.AmpHack.book_transit.Chat.Chat_Sender;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void dataStart(View view) {
        Intent intent= new Intent(MainActivity.this, Chat_Sender.class);
        startActivity(intent);
    }
}
